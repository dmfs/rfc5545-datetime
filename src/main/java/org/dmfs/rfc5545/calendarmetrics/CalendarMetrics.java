...
public abstract class CalendarMetrics
{
     ...
     * #packedMonth(int)} and {@link #dayOfMonth(int)} like in:
     *
     * <pre>
     ...
     * <p>
     * If the day belongs to the previous year zero or a negative value is returned. If the day belongs to the next year the result is larger than {@link
     * #getDaysPerYear(int)} for <code>year</code>.
     * </p>
     *
     * @param year
     *         The year.
